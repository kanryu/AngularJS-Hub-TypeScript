...
class IdHolder {
  ...
  // BaseProvider
  static createInstance():IdHolder {
    return new IdHolder();
  }
}
...
angular.module("childModule1", [])
  .provider("provider1", IdHolder.createInstance)
  .config(function (provider1Provider:IdHolder)
  {
    provider1Provider.setID("provider1-childModule1");
  })
  .provider("provider2", IdHolder.createInstance)
  .config(function (provider2Provider:IdHolder)
  {
...
angular.module("childModule2", ["childModule3"])
  ...
  .provider("provider3", IdHolder.createInstance)
  .config(function (provider3Provider:IdHolder)
  {
...
angular.module("childModule3", [])
  ...
  .provider("provider4", IdHolder.createInstance)
  .config(function (provider4Provider:IdHolder)
  {
