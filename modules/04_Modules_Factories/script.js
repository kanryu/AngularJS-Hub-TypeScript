...
var PersonManager = (function () {
    ...
    PersonManager.getInstance = function (person) {
        if (!PersonManager.personManager) {
            PersonManager.personManager = new PersonManager(person);
        }
        return PersonManager.personManager;
    };
...
mainModule.value("person", {
    firstName: "",
    lastName: ""
}).factory("personManager", PersonManager.getInstance).controller("mainController", function ($scope, person, personManager) {
