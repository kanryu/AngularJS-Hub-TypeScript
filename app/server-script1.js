...
mainModule.controller("mainController", function ($scope, $http, jsonFilter) {
    ...
    $scope.simpleGetCall = function (withSuccess) {
        var callURL = (withSuccess ? server_uri : "invalid-url.php");
    ...
    $scope.getCall = function () {
        ...
        $http.get(server_uri, config).success(function (data, status, headers, config) {
    ...
    $scope.postCall = function () {
        ...
        $http.post(server_uri, $scope.postData, config).success(function (data, status, headers, config) {
    ...
    $scope.putCall = function () {
        ...
        $http.put(server_uri, $scope.putData, config).success(function (data, status, headers, config) {
    ...
    $scope.deleteCall = function () {
        ...
        $http.delete(server_uri, config).success(function (data, status, headers, config) {
    ...
    $scope.headCall = function () {
        ...
        $http.head(server_uri, config).success(function (data, status, headers, config) {
