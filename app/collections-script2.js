...
var CustomCurrencyFilter = (function () {
    function CustomCurrencyFilter() {
    }
    CustomCurrencyFilter.Factory = function (numberFilter) {
...
}).filter("customCurrency", CustomCurrencyFilter.Factory);
