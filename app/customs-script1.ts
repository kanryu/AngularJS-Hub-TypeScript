...
var logLine = function (logVariable:string, directiveName:string, logString:string)
{
  if (logScope)
  {
...
mainModule.controller("mainController", function ($scope)
  ...
  .directive("nghPrePostlinkFunction", function ():any
  {
    // Initialization
  ...
  .directive("nghCompileFunction", function ():any
  {
    // Initialization
    ...
    return {
      ...
      compile: function (element, attrs:any)
      {
        ...
        return {
          ...
          // Post-link function
          post: function (scope, element, attrs:any)
          {
