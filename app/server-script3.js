...
mainModule.factory("PeopleService", ['$resource', function ($resource) {
    ...
    var resource = $resource(PEOPLE_URI + "/:operation/:id", {
        id: 0
    }, {
...
//mainModule.$inject = ['$scope'];
mainModule.controller("mainController", ['$scope', '$resource', 'PeopleService', 'PersonResource', 'jsonFilter', function ($scope, $resource, PeopleService, PersonResource, jsonFilter) {
